...
export class ScraperService extends BaseService {
  private readonly CHARTINK_URL = 'https://chartink.com/screener/copy-r2-bear-squeeze-setup-bss-13';
  ...
  private async extractAllStocks(page: puppeteer.Page, totalStocks: number, globalSeenSymbols: Set<string>): Promise<StockData[]> {
    const allStocks: StockData[] = [];
